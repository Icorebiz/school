...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        /**
         * Override method to intercept command name
         *
        ...
        {
            return \Icorebiz\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status)
        {
            ...
            \Icorebiz\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Icorebiz\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Icorebiz\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Icorebiz\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Icorebiz\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Icorebiz\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Icorebiz\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Icorebiz\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Icorebiz\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @return \Icorebiz\DMS\Models\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \Icorebiz\DMS\Models\User|false 
         * @static 
         */ 
         ...
         *
         * @return \Icorebiz\DMS\Models\User 
         * @static 
         */ 
    ...
    class Queue {
        ...
        {
            return \Barryvdh\Queue\AsyncQueue::getJobFromId($id);
        }
        ...
        {
            \Barryvdh\Queue\AsyncQueue::startProcess($id);
        }
        ...
        public static function size($queue = null)
        {
            ...
            return \Barryvdh\Queue\AsyncQueue::size($queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            return \Barryvdh\Queue\AsyncQueue::release($queue, $job, $delay);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            \Barryvdh\Queue\AsyncQueue::deleteReserved($queue, $id);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            return \Barryvdh\Queue\AsyncQueue::getDatabase();
        }
        ...
        public static function pushOn($queue, $job, $data = '')
        {
            ...
            return \Barryvdh\Queue\AsyncQueue::pushOn($queue, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Barryvdh\Queue\AsyncQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Barryvdh\Queue\AsyncQueue::getConnectionName();
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Barryvdh\Queue\AsyncQueue::setConnectionName($name);
        }
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function api($data = null, $code = null, $message = null, $transformable = true)
        {
            return \Illuminate\Routing\ResponseFactory::api($data, $code, $message, $transformable);
        }
...
namespace Spinen\Geometry { 
    ...
    class GeometryFacade {
         ...
         * @static 
         */ 
        public static function buildGeometryClassName($geometry)
        {
            return \Spinen\Geometry\Geometry::buildGeometryClassName($geometry);
        }
         ...
         * @static 
         */ 
        public static function parse($data, $type = null)
        {
            return \Spinen\Geometry\Geometry::parse($data, $type);
        }
...
namespace  { 
    ...
    class Geo extends \Spinen\Geometry\GeometryFacade {}
